    ...
    <div className="fixed inset-x-0 bottom-16 z-20 border-t bg-white px-4 py-4 shadow-lg sm:bottom-0 sm:px-6">
      <div className="mx-auto flex max-w-lg items-center gap-4">
        ...
        <button
          ...
          className={cn(
            "flex flex-1 items-center justify-center gap-2 rounded-full px-6 py-3 font-semibold text-white shadow-xl shadow-emerald-500/35 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400",
            effectiveDisabled
              ? "bg-emerald-600/80"
